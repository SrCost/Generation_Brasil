programa
{
	...
	funcao inicio()
	{
	/*João, homem de bem, comprou um microcomputador para controlar o rendimento 
	 ...
	 * deve pagar um multa de R$ 4,00 por quilo excedente. João precisa que 
	 * você faça um sistema que leia a variável P (peso de tomates) e 
